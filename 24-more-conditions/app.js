...
if (person.takeAdmision) {
    ...
    if (person.university === 'Hardvard') {
        ...
        if (university1.admissionOpen) {
            ...
            // Age Required
            if (person.age >= university1.ageRequired.min &&
                person.age <= university1.ageRequired.max) {
                console.log('Your are Illegible');
            } //illegible
            else {
                console.log('Your are not Illegible');
            } // not illegible
        }
        // Admision not Open
        else {
            console.log('Hardvard admisions are not open');
        }
    }
    // Cambridge University
        ...
        if (university2.admissionOpen) {
            ...
            // Age Required
            if (person.age >= university2.ageRequired.min &&
        ...
        // Admision not Open
            ...
            console.log('Cambridge admisions are not open');
        }
    }
}
